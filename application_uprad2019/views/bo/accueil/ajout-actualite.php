<div class="content-wrapper" style="min-height: 915.667px;">
    ...
    <section class="content">
        <div class="row">
            <form method="POST" action="<?php echo site_url('admin-uprad/ajout-actualite'); ?>" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input type="text" name="titre" class="form-control pull-right" placeholder="titre de l'actualité" require="required">
                                </div>
                                <!-- /.input group -->
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input type="text" name="meta-title" class="form-control pull-right" placeholder="titre pour le referencement(SEO)">
                                </div>
                                <!-- /.input group -->
                            </div>
                            <!-- /.form group -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <textarea name="resume" class="form-control pull-right" placeholder="resumé de l'article ici"></textarea>
                                </div>
                                <!-- /.input group -->
                            </div>
                            <!-- /.form group -->
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <div class="col-xs-12 col-sm-6 no_padding">
                                <input type="checkbox" name="status" id="choix_doc_educ" value="<?php echo 'checked' ? 1 : 0; ?>">
