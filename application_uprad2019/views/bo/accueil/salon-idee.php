                                            ...
                                            <?php if (!empty($salons)) {
                                                foreach ($salons as $salon) { ?>
                                                    <tr class="odd" role="row">
                                                        ...
                                                        <td>
                                                            <a class="btn btn-info btn-sm" href="<?php echo site_url('admin-uprad/update-actualite/' . $salon->id); ?>" type="button">
                                                                Modif <i class="fa fa-edit" title="Modifier"></i>
                                                            </a>
                                                            <a class="btn btn-danger btn-sm" href="<?php echo site_url('admin-uprad/delete-actualite/' . $salon->id); ?>" type="button">
