            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">90<small>%</small>
                        </span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
            ...
            <div class="col-md-8">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="box box-warning direct-chat direct-chat-warning">
                            <div class="box-header with-border">
                                ...
                                <div class="box-tools pull-right">
                                    <span class="badge bg-yellow" data-toggle="tooltip" title="3 New Messages">3</span>
                                    <button class="btn btn-box-tool" data-widget="collapse" type="button">
                                        <i class="fa fa-minus"></i>
                                    </button>
                            ...
                            <div class="box-body">
                                ...
                                <div class="direct-chat-contacts">
                                    <ul class="contacts-list">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img alt="User Image" class="contacts-list-img" src="dist/img/user7-128x128.jpg">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img alt="User Image" class="contacts-list-img" src="dist/img/user3-128x128.jpg">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img alt="User Image" class="contacts-list-img" src="dist/img/user5-128x128.jpg">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img alt="User Image" class="contacts-list-img" src="dist/img/user6-128x128.jpg">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img alt="User Image" class="contacts-list-img" src="dist/img/user8-128x128.jpg">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="box box-danger">
                            ...
                            <div class="box-footer text-center">
                                <a class="uppercase" href="javascript:void(0)">View All Users</a>
                            </div>
                            <!-- /.box-footer -->
                        </div>
                        <!--/.box -->
                ...
                <div class="box box-info">
                    ...
                    <div class="box-footer clearfix">
                        <a class="btn btn-sm btn-info btn-flat pull-left" href="javascript:void(0)">Place New Order</a>
                        <a class="btn btn-sm btn-default btn-flat pull-right" href="javascript:void(0)">View All Orders</a>
                    </div>
                    <!-- /.box-footer -->
                </div>
                <!-- /.box -->
                    ...
                    <div class="box-body">
                        <ul class="products-list product-list-in-box">
                            ...
                            <li class="item">
                                ...
                                <div class="product-info">
                                    <a class="product-title" href="javascript:void(0)">Xbox One
