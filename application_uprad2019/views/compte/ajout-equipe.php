<div class="content-wrapper" style="min-height: 915.667px;">
    ...
    <section class="content">
        <div class="row">
            ...
            <form method="POST" <?php if (empty($editer)) { ?> action="<?php echo site_url('admin-uprad/ajout-equipe'); ?>" <?php } else { ?>action="<?php echo site_url('admin-uprad/update-equipe'); ?>" <?php } ?> enctype="multipart/form-data">
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 input-group date">
                                    <input type="text" name="twitter" class="form-control pull-right" placeholder="Twitter">
                                    <span class="input-group-addon">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 input-group date">
                                    <input type="text" name="skype" class="form-control pull-right" placeholder="skype">
                                    <span class="input-group-addon">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 input-group date">
                                    <input type="text" name="facebook" class="form-control pull-right" placeholder="facebook">
                                    <span class="input-group-addon">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 input-group date">
                                    <input type="text" name="linkdin" class="form-control pull-right" placeholder="linkdin">
                                    <span class="input-group-addon">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 input-group date">
                                    <input type="text" name="youtube" class="form-control pull-right" placeholder="youtube">
                                    <span class="input-group-addon">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 input-group date">
                                    <input type="text" name="service" class="form-control pull-right" placeholder="fonction" value="<?php echo !empty($editer->fonction) ? $editer->fonction : ''; ?>">
                                    <span class="input-group-addon">
                            ...
                            <input type="hidden" name="photo" value="<?php echo !empty($editer->photo) ? $editer->photo : ''; ?>">
                        </div>
                        <!-- /.box-body -->
                    </div>
                    <!-- /.box -->
